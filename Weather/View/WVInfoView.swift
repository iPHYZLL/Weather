...
class WVInfoView : UIView {
    ...
    init(style : WVInfoViewStyle) {
        ...
        if style == .vertical {
            ...
            valueLabel.anchor(top: nil, paddingTop: 0, right: rightAnchor, paddingRight: padding, left: centerXAnchor, paddingLeft: 5, bottom: nil, paddingBottom: 0, width: 0, height: 20)
